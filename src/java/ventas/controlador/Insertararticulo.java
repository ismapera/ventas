...
public class Insertararticulo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           arti.setNombArt(request.getParameter("nombArt").toUpperCase());
           arti.setPrecioArt(Double.parseDouble(request.getParameter("precioArt").toUpperCase()));
            
           Articulo artiaux=new Articulo();
            artiaux.insertar(arti);
